[[logging:Default,includesConstraints="logging:IsyLoggerMustBeUsed","logging:IsyLoggerMustBeDeclaredAsConstant"]]
== Logging
...
[source,cypher,role=constraint,requiresConcepts="logging:Logger"]
----
MATCH
