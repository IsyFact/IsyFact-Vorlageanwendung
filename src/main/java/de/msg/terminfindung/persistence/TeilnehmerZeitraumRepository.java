 ...
 */
@Repository
public interface TeilnehmerZeitraumRepository extends CrudRepository<TeilnehmerZeitraum, Long> {

    List<TeilnehmerZeitraum> findByTeilnehmer(Teilnehmer teilnehmer);
