...
public class AwkWrapperImpl implements AwkWrapper {
    ...
    public AwkWrapperImpl(Erstellung erstellung, Verwaltung verwaltung, Teilnahme teilnahme,
        Mapper beanMapper) {
    ...
    public TerminfindungModel erstelleTerminfindung(String organisatorName, String veranstaltungName,
        ...
        Terminfindung terminfindung =
            erstellung.erstelleTerminfindung(organisatorName, veranstaltungName, termine);

        return map(terminfindung);
    }

    @Override
    public TerminfindungModel ladeTerminfindung(UUID terminfindungsRefNr)
    ...
    @Override
    public TerminfindungModel setzeVeranstaltungstermin(TerminfindungModel terminfindungModel,
        long zeitraumNr) throws TerminfindungBusinessException {
    ...
    public List<TerminfindungModel> ladeAlleTerminfindungen() {
        ...
        verwaltung.leseAlleTerminfindungen().forEach(tf -> model.add(map(tf)));
