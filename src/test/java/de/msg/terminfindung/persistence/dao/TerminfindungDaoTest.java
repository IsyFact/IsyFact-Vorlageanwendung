...
public class TerminfindungDaoTest extends AbstraktDaoTest {
    ...
    public void testSpeichern() {
        terminfindungDao.save(new Terminfindung("Grillfest 2016", new Organisator("Sepp")));
    }

    @Test
    @DatabaseSetup("testTerminfindungDaoSetup.xml")
    public void testSuchenMitId() {
        Terminfindung terminfindung = terminfindungDao.findOne(TERMINFINDUNG_ID);
    ...
    public void testSuchenMitRef() {
        Terminfindung terminfindung = terminfindungDao.findByIdRef(TERMINFINDUNG_REF);
    ...
    public void testFindeAlle() {
        ...
        terminfindungDao.findAll().forEach(alleTerminfindungen::add);
    ...
    public void testLoesche() {
        Terminfindung terminfindung = terminfindungDao.findOne(TERMINFINDUNG_ID);
        terminfindungDao.delete(terminfindung);

        assertNull(terminfindungDao.findOne(TERMINFINDUNG_ID));
    }
